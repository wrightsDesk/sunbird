...
class Blacklist_Lockout extends Setting {
	...
	public function get_default_values(): array {
		return array(
			'message' => esc_html__( 'The administrator has blocked your IP from accessing this website.', 'defender-security' ),
		);
	}
	...
	public function labels(): array {
		return array(
			'ip_blacklist'        => esc_html__( 'IP Banning - IP Addresses Blocklist', 'defender-security' ),
			'ip_whitelist'        => esc_html__( 'IP Banning - IP Addresses Allowlist', 'defender-security' ),
			'country_blacklist'   => esc_html__( 'IP Banning - Country Allowlist', 'defender-security' ),
			'country_whitelist'   => esc_html__( 'IP Banning - Country Blocklist', 'defender-security' ),
			'ip_lockout_message'  => esc_html__( 'IP Banning - Lockout Message', 'defender-security' ),
			'maxmind_license_key' => esc_html__( 'MaxMind license key', 'defender-security' ),
		);
	}

...
class Login_Lockout extends Setting {
	...
	public function get_default_values(): array {
		return array(
			'message' => esc_html__( 'You have been locked out due to too many invalid login attempts.', 'defender-security' ),
		);
	}
	...
	public function labels(): array {
		return array(
			...
			// New key: attempt.
			'login_protection_login_attempt'         => esc_html__( 'Login Protection - Threshold', 'defender-security' ),
			// New key: timeframe.
			'login_protection_lockout_timeframe'     => esc_html__( 'Login Protection - Timeframe', 'defender-security' ),
			// New key: lockout_type.
			'login_protection_lockout_ban'           => esc_html__( 'Login Protection - Duration Type', 'defender-security' ),
			// New key: duration.
			'login_protection_lockout_duration'      => esc_html__( 'Login Protection - Duration', 'defender-security' ),
			// New key: duration_unit.
			'login_protection_lockout_duration_unit' => esc_html__( 'Login Protection - Duration units', 'defender-security' ),
			// New key: lockout_message.
			'login_protection_lockout_message'       => esc_html__( 'Login Protection - Lockout Message', 'defender-security' ),
			'username_blacklist'                     => esc_html__( 'Login Protection - Banned Usernames', 'defender-security' ),
		);
	}
	...
	public static function get_module_name(): string {
		return esc_html__( 'Login Protection', 'defender-security' );
	}

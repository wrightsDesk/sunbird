...
class Password_Protection extends Setting {
	...
	public function labels(): array {
		return array(
			...
			'pwned_actions' => esc_html__( 'Force password change', 'defender-security' ),
			'user_roles'    => esc_html__( 'User Roles', 'defender-security' ),
		);
	}
	...
	public static function get_module_name(): string {
		return esc_html__( 'Pwned Passwords', 'defender-security' );
	}
}

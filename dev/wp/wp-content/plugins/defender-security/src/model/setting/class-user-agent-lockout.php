...
class User_Agent_Lockout extends Setting {
	...
	public function labels(): array {
		return array(
			...
			'message'       => esc_html__( 'Message', 'defender-security' ),
			'blacklist'     => esc_html__( 'Blocklist', 'defender-security' ),
			'whitelist'     => esc_html__( 'Allowlist', 'defender-security' ),
			'empty_headers' => esc_html__( 'Empty Headers', 'defender-security' ),
		);
	}
	...
	public static function get_module_name(): string {
		return esc_html__( 'User Agent Banning', 'defender-security' );
	}

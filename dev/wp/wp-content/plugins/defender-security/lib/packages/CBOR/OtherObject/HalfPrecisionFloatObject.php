...
namespace WP_DEFENDER_VENDOR\CBOR\OtherObject;

use WP_DEFENDER_VENDOR\Brick\Math\BigInteger;
use WP_DEFENDER_VENDOR\CBOR\Normalizable;
use WP_DEFENDER_VENDOR\CBOR\OtherObject as Base;
use WP_DEFENDER_VENDOR\CBOR\Utils;
use const INF;

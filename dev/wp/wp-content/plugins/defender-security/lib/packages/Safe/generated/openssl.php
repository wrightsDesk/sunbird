 ...
 * CSR.
 * @param array|null $configargs By default, the information in your system openssl.conf
 ...
 *
 *
 * @param array|null $extraattribs extraattribs is used to specify additional
 ...
 * @param array|null            $configargs You can finetune the CSR signing by configargs.
 ...
 * @param array|null            $args     Optional array, other keys will be ignored.
 *
 *
 *
 *
 ...
 * @param string|null           $extracerts  extracerts specifies the name of a file containing
 ...
 * passphrase.
 * @param array|null            $configargs  configargs can be used to fine-tune the export
 ...
 *
 * @param array|null $configargs You can finetune the key generation (such as specifying the number of

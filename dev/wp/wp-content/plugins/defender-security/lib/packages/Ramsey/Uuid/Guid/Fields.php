...
namespace WP_DEFENDER_VENDOR\Ramsey\Uuid\Guid;

use WP_DEFENDER_VENDOR\Ramsey\Uuid\Exception\InvalidArgumentException;
use WP_DEFENDER_VENDOR\Ramsey\Uuid\Fields\SerializableFieldsTrait;
use WP_DEFENDER_VENDOR\Ramsey\Uuid\Rfc4122\FieldsInterface;
use WP_DEFENDER_VENDOR\Ramsey\Uuid\Rfc4122\MaxTrait;
use WP_DEFENDER_VENDOR\Ramsey\Uuid\Rfc4122\NilTrait;
use WP_DEFENDER_VENDOR\Ramsey\Uuid\Rfc4122\VariantTrait;
use WP_DEFENDER_VENDOR\Ramsey\Uuid\Rfc4122\VersionTrait;

 ...
 *
 * ``` php
 * $collection = new \WP_DEFENDER_VENDOR\Ramsey\Collection\Collection('My\\Foo');
 ...
 * namespace My\Foo;
 *
 * class FooCollection extends \WP_DEFENDER_VENDOR\Ramsey\Collection\AbstractCollection
 * {

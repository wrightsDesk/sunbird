...
namespace WP_DEFENDER_VENDOR\FG\ASN1;

use WP_DEFENDER_VENDOR\FG\ASN1\Exception\ParserException;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\BitString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\Boolean;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\Enumerated;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\GeneralizedTime;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\Integer;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\NullObject;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\ObjectIdentifier;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\RelativeObjectIdentifier;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\OctetString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\Sequence;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\Set;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\UTCTime;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\IA5String;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\PrintableString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\NumericString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\UTF8String;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\UniversalString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\CharacterString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\GeneralString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\VisibleString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\GraphicString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\BMPString;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\T61String;
use WP_DEFENDER_VENDOR\FG\ASN1\Universal\ObjectDescriptor;
use WP_DEFENDER_VENDOR\FG\Utility\BigInteger;
use LogicException;
...
abstract class ASNObject implements Parsable
{
     ...
     *
     * @return \WP_DEFENDER_VENDOR\FG\ASN1\ASNObject
     */

...
namespace WP_DEFENDER_VENDOR\FG\X509\SAN;

use WP_DEFENDER_VENDOR\FG\ASN1\ASNObject;
use WP_DEFENDER_VENDOR\FG\ASN1\Parsable;
...
class IPAddress extends ASNObject implements Parsable
{
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex = 0)
    {
        ...
        if ($contentLength != 4) {
            throw new ParserException("A WP_DEFENDER_VENDOR\FG\\X509\SAN\IPAddress should have a content length of 4. Extracted length was {$contentLength}", $offsetIndex);
        }

...
{
    /** @var \WP_DEFENDER_VENDOR\FG\ASN1\ASNObject[] */
    protected $children;
    private $iteratorPosition;

    /**
     * @param \WP_DEFENDER_VENDOR\FG\ASN1\ASNObject[] $children the variadic type hint is commented due to https://github.com/facebook/hhvm/issues/4858
     */

...
namespace WP_DEFENDER_VENDOR\League\Uri;

use finfo;
use WP_DEFENDER_VENDOR\League\Uri\Contracts\UriInterface;
use WP_DEFENDER_VENDOR\League\Uri\Exceptions\FileinfoSupportMissing;
use WP_DEFENDER_VENDOR\League\Uri\Exceptions\IdnaConversionFailed;
use WP_DEFENDER_VENDOR\League\Uri\Exceptions\IdnSupportMissing;
use WP_DEFENDER_VENDOR\League\Uri\Exceptions\SyntaxError;
use WP_DEFENDER_VENDOR\League\Uri\Idna\Idna;
use WP_DEFENDER_VENDOR\Psr\Http\Message\UriInterface as Psr7UriInterface;
use TypeError;

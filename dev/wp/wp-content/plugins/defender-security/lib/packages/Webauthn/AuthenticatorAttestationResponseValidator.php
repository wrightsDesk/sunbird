...
use function WP_DEFENDER_VENDOR\Safe\parse_url;
use function WP_DEFENDER_VENDOR\Safe\sprintf;
use Throwable;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\AttestationObject;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\AttestationStatement;
...
use WP_DEFENDER_VENDOR\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientOutputs;
use WP_DEFENDER_VENDOR\Webauthn\AuthenticationExtensions\ExtensionOutputCheckerHandler;
use WP_DEFENDER_VENDOR\Webauthn\CertificateChainChecker\CertificateChainChecker;
use WP_DEFENDER_VENDOR\Webauthn\MetadataService\MetadataStatement;
use WP_DEFENDER_VENDOR\Webauthn\MetadataService\MetadataStatementRepository;
use WP_DEFENDER_VENDOR\Webauthn\MetadataService\StatusReport;

...
use WP_DEFENDER_VENDOR\Cose\Algorithm\ManagerFactory;
use WP_DEFENDER_VENDOR\Cose\Algorithm\Signature\ECDSA;
use WP_DEFENDER_VENDOR\Cose\Algorithm\Signature\EdDSA;
use WP_DEFENDER_VENDOR\Cose\Algorithm\Signature\RSA;
...
use WP_DEFENDER_VENDOR\Psr\Http\Message\ServerRequestInterface;
use WP_DEFENDER_VENDOR\Psr\Log\LoggerInterface;
use WP_DEFENDER_VENDOR\Psr\Log\NullLogger;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\AndroidKeyAttestationStatementSupport;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\AndroidSafetyNetAttestationStatementSupport;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\AttestationObjectLoader;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\AttestationStatementSupportManager;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\FidoU2FAttestationStatementSupport;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\NoneAttestationStatementSupport;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\PackedAttestationStatementSupport;
use WP_DEFENDER_VENDOR\Webauthn\AttestationStatement\TPMAttestationStatementSupport;
use WP_DEFENDER_VENDOR\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientInputs;
use WP_DEFENDER_VENDOR\Webauthn\AuthenticationExtensions\ExtensionOutputCheckerHandler;
use WP_DEFENDER_VENDOR\Webauthn\Counter\CounterChecker;
use WP_DEFENDER_VENDOR\Webauthn\MetadataService\MetadataStatementRepository;
use WP_DEFENDER_VENDOR\Webauthn\TokenBinding\IgnoreTokenBindingHandler;
use WP_DEFENDER_VENDOR\Webauthn\TokenBinding\TokenBindingHandler;

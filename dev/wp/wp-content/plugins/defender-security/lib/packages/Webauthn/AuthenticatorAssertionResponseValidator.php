...
use WP_DEFENDER_VENDOR\Cose\Algorithm\Manager;
...
use WP_DEFENDER_VENDOR\Webauthn\Counter\ThrowExceptionIfInvalid;
use WP_DEFENDER_VENDOR\Webauthn\TokenBinding\TokenBindingHandler;
use WP_DEFENDER_VENDOR\Webauthn\Util\CoseSignatureFixer;

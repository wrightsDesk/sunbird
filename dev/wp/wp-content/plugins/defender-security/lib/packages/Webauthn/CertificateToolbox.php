...
use WP_DEFENDER_VENDOR\Safe\Exceptions\FilesystemException;
use function WP_DEFENDER_VENDOR\Safe\file_put_contents;
use function WP_DEFENDER_VENDOR\Safe\ksort;
use function WP_DEFENDER_VENDOR\Safe\mkdir;
use function WP_DEFENDER_VENDOR\Safe\rename;
use function WP_DEFENDER_VENDOR\Safe\sprintf;
use function WP_DEFENDER_VENDOR\Safe\tempnam;
use function WP_DEFENDER_VENDOR\Safe\unlink;
use WP_DEFENDER_VENDOR\Symfony\Component\Process\Process;

class CertificateToolbox
{
    /**
     * @deprecated "This method is deprecated since v3.3 and will be removed en v4.0. Please use WP_DEFENDER_VENDOR\Webauthn\CertificateChainChecker\CertificateChainChecker instead"
     *

...
class Strong_Testimonials_Defaults {
	...
	public static function get_view_options() {
		$default_view_options = array(
			...
			'order'                  => array(
				...
				'submit_date' => esc_html_x( 'submit date', 'display order', 'strong-testimonials' ),
			),
		...
		return apply_filters( 'wpmtst_view_options', $default_view_options );
	}
	...
	public static function get_default_view() {
		$default_view = array(
			...
			'form_template'         => 'default-form-theme',

...
/**
 * Class Browser_Id_Metric - Handles SQL generation for the 'browser_id' metric.
 */
class Browser_Id_Metric implements Metric_Handler_Interface {
	/**
	...
	public function apply( Statistics_Query $qd ): void {
		$qd->add_select( 'sessions.browser_id AS browser_id' );
		$qd->with( 'sessions' );
	}
}
